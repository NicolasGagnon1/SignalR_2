...
namespace signalr.backend.Hubs
{
    ...
    public class ChatHub : Hub
    {
        ...
        public async override Task OnConnectedAsync()
        {
            ...
            await Clients.All.SendAsync("UsersList", await _context.Users.ToListAsync());
        }
        ...
        public async override Task OnDisconnectedAsync(Exception? exception)
        {
            ...
            await Clients.All.SendAsync("MisAJour", "Déconnecté");
        }
        ...
        public async Task JoinChannel(int oldChannelId, int newChannelId)
        {
            ...
            await Groups.RemoveFromGroupAsync(CreateChannelGroupName(oldChannelId), "anciengroupe");
            // TODO: Faire joindre le nouveau canal à l'utilisateur
            await Groups.AddToGroupAsync(CreateChannelGroupName(newChannelId), "nouveaugroupe");
        }
